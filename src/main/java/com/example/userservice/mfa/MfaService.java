...
public class MfaService {
    ...
    public Mfa updateMfa(Mfa mfa) {
        if(!mfa.getType().equals("None") && !mfa.getType().equals("Application") && !mfa.getType().equals("Phone")) throw new ApiRequestException("Type is invalid. Valid types : None, Application, Phone", HttpStatus.BAD_REQUEST);
